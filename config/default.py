...
_C.BASE = ['']
_C.NAME = ''
_C.DATA_DIR = '/home/ouc/fbj/car_data/car_data/'
...
_C.MODEL.PRETRAINED = '/home/ouc/fbj/xiaofan/esvit-main/swin_tiny_patch4_window7_224.pth'
_C.MODEL.PRETRAINED_LAYERS = ['*']
_C.MODEL.NUM_CLASSES = 196
