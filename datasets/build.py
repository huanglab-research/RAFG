...
class DataAugmentationDINO(object):
    def __init__(self, global_crops_scale, local_crops_scale, local_crops_number, local_crops_size=96):
        ...
        self.global_transform = transforms.Compose([
            ...
            # transforms.ToTensor(),  # 注意这里的 ToTensor 是 torchvision.transforms 的方法
    ...
    def __call__(self, image):
        crops = []
        x1 = self.global_transform(image)
        x2 = self.global_transform(image)
        ...
        # print(f"88888888888888888888888888888888888888888888")
        crops.append(self.global_transform2(x1))
        crops.append(self.global_transform2(x2))
        # print(f"99999999999999999999999999999999999999999999")
