...
class LinearClassifier(nn.Module):
    ...
    def __init__(self, dim, num_labels=196):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrained_weights', default='/home/ouc/fbj/xiaofan/esvit6/output1/checkpoint0035.pth', type=str, help="Path to pretrained weights to evaluate.")
    ...
    parser.add_argument('--num_labels', default=196, type=int, help='number of classes in a dataset')
